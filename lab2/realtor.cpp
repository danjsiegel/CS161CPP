...
//header files
  ...
  int main()
  {
    ...
    string lastName;
    double cost_of_house, price_to_sell, price_of_comission
    const double percentage_to_sell = .06 * cost_of_house;
    const double percentage_of_comission = .25 * cost_to_sell;
